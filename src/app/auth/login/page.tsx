...
export default function Login() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        if (res.success) {
            ...
            if(res?.message.match('email'))
            {
                ...
                setError({ ...error, generic: "wrong password, please retry" })
            }
        }
    }
    ...
    return (
        ...
        <div className="w-full bg-gray-50 text-black font-[Poppin]">
            <div className="flex flex-col items-center text-center justify-center px-6 py-8 mx-auto lg:py-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl ">
                            Identification Classic Portfolio
                        </h1>
                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/auth/reset" className="text-sm font-medium text-orange-600 hover:underline ">Mot de passe oublié?</Link>
                            </div>
                            {
                            ...
                            <p className="text-sm text-black ">
                                Vous n'avez pas encore de compte? <Link href={"/auth/register"} className="font-medium text-orange-600 hover:underline ">S'inscrire</Link>
                            </p>
                        </form>
                    </div>
            </div>
